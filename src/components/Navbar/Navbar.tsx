...
import logo from "../../assets/images/sports-logo.jpg";
      ...
      <div className={`${classes.width60} ${classes.alignCenter}`}>
            ...
            <Suspense fallback={'loading...'}>
                <AuthCheck fallback={
                    ...
                    <li>
                        <Button>
                            <Link to="/Sportspage" className={`${classes.navbarItem} ${classes.psides}`}>Sports List</Link>
                        </Button>
                    </li>
                    <li>
                        <Button>
                    ...
                    <li>
                        <Button>
                            <Link to="/Photos" className={`${classes.navbarItem} ${classes.psides}`}>Sport Photos</Link>
                        </Button>
                    </li>
                    </AuthCheck>
                </Suspense>
